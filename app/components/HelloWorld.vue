    ...
    <Page class="page">
        ...
        <ScrollView>
            <StackLayout class="home-panel">
                ...
                <FlexboxLayout>
                    <Button class="food-button btn" text="Food" @tap="onButtonTap" v-on:click="post"/>
                    <Button class="entertainment-button btn" text="Entertainment" @tap="onButtonTap"/>
                    <Button class="nature-button btn" text="Nature" @tap="onButtonTap"/>
                </FlexboxLayout>
            </StackLayout>
        </ScrollView>
    </Page>
